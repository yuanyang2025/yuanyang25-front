      ...
      <div style={{ width: "100%", height: "100%" }}>
        <div style={{ width: "94%", margin: "3%" }}>
          ...
          <div style={{fontSize: "16px",
              ...
              fontWeight: "bold",
              fontStyle:"italic"}}>
            <p>蛇影盘旋在楼顶，灵气萦绕在周围，这就是灵蛇塔吗？</p>
            <p>看着眼前的建筑物，你不禁陷入沉思。说实话每年春节探险真是个体力活，但是岽半仙的压岁钱给得实在是太多了！如今半仙连影子都没有，只有他的字迹撑场面。要不是自己变小了，真想直接给半仙打个电话。迟疑之际，塔外的地上，一份斑驳的笔记本吸引着你的视线。</p>
            <br />
            <p>你好，来灵蛇塔的陌生人!</p>
            <p>相信你来这里，都是为了我们共同的目标：完成守塔蛇的试炼，获得自己所欲求之物。我把自己的探索笔记，记在此处，希望能帮到你。</p>
            <p>鹅老板</p>
