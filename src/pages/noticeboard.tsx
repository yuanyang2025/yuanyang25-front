  ...
  return (
    <div style={{ width: "device-width" }}>
      ...
      <Alert
        ...
        description={
          <div>
            <p>在2025.01.29 14时许，出题组发现有《不好笑》和《听力测试》的答案在跨队伍的群内泄露。为此出题组展开反作弊行动，但由于出题组内部沟通问题而导致出现了相当大范围的误封情况。</p>
            <p>出题组在此向所有队伍表示歉意。部分核实是误封的队伍已经恢复了答题和排名资格，并根据锁定时间长短给予了灵力值补偿。</p>
            <p>当前的处理结果如下：</p>
            <ul>
              <li>队伍74,163,161,90,50,73,126,91,92仍维持原处罚不变。</li>
              <li>队伍32,21,12,51,108的申诉复核通过，已恢复正常状态。</li>
              <li>未申请复核的队伍在北京时间2025.01.30 00:00前向出题组发起申诉仍然有效。</li>
            </ul>
            <strong style={{fontSize:"135%"}}>
              另外出题组判断后，决定在2025.01.29 22:30 CST 向所有已经注册的队伍发送【50000 灵力值】作为补偿。该全局补偿已经生效。
            </strong>
            <p>最后感谢各位的信任与支持。由于出题组水平有限，在题目、操作和网页设计上多有疏漏，恳请各位批评斧正。</p>
          </div>
        }
        showIcon
        type="success"
